...
{
	{ L"JOSEPHnareff P1", DESC_NODETYPE_TREE, (void*)VENTURE_A_JOSEPH_P1, ARRAYSIZE(VENTURE_A_JOSEPH_P1) },
    { L"JOSEPHnareff P2", DESC_NODETYPE_TREE, (void*)VENTURE_A_JOSEPH_P2, ARRAYSIZE(VENTURE_A_JOSEPH_P2) },
};
